...
attachPolicyCommand = "aws iam attach-role-policy --role-name script-{}-role --policy-arn arn:aws:iam::{}:policy/ecr-codebuild-all-resources".format(configData['iam-user'],configData['account-id'])
